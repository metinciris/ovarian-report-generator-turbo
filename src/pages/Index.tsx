...
const initialFormData: FormData = {
  ...
  histologicType: [],
  histologicGradeWHO: "not_selected",
  figoGrade: "not_selected",
  silverbergGrade: "not_selected",
  growthPatternGrade: "not_selected",
  twoTierGrade: "not_selected",
  threeTierGrade: "not_selected",
  lymphaticVascularInvasion: "not_selected",
  perineuralInvasion: "not_selected",
  p53IHC: "not_selected",
  implants: "not_selected",
  largestExtrapelvicFocus: "not_selected",
  peritonealAscitic: "not_selected",
  treatmentEffect: "not_selected",
  otherTissueInvolvement: [],
  ectocervicalVaginalMargin: "not_selected",
  parametrialMargin: "not_selected",
  lymphNodesExamined: "",
